package com.kulpin.project.travelcompanion.server.config;
...
@Configuration
@EnableJpaRepositories("com.kulpin.project.travelcompanion.server.repository")
@EnableTransactionManagement
@ComponentScan("com.kulpin.project.travelcompanion.server")
